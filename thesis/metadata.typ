...
#let naslov = "Предвиђање нивоа депресије на основу клиничких интервјуа применом машинског учења"
#let autor = "Веселин Рогановић"

// На енглеском
#let naslov_eng = "Predicting depression severity from clinical interviews using machine learning"
#let autor_eng = "Veselin Roganović"

#let indeks = "SV 36/2022"

// Име и презиме ментора
#let mentor = "Милан Сегединац"
...
#let mentor_eng = "Milan Segedinac"
